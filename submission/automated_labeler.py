...
# academic integrity note: used LLMs for questions when stuck, but didn't use them to write the assignment
...
class AutomatedLabeler:
    ...
    def load_dog_hashes(self) -> List[str]:
        ...
        dog_hashes = []
        # phash all images in the dog-list-images directory
